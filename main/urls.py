...
from .views import BankViewSet, BranchViewSet, ExchangeRateViewSet, BankBranchesView, CurrencyViewSet, UpdateExchangeRatesView, AddBranchView, auth_branch
...
urlpatterns = [
    ...
    path('banks/branches/login', auth_branch, name='bank-branches-login'),
